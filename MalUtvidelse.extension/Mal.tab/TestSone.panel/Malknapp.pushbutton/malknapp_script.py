...
__helpurl__ = "whatever.com"  # Hjelp URL når bruker trykker F1 over knapp.
__min_revit_ver__ = 2017  # knapp deaktivert hvis klient bruker lavere versjon
__max_revit_ver__ = 2018  # Skjønner?
__beta__ = True  # Knapp deaktivert hos brukere som ikke har spesifikt aktivert betaknapper
